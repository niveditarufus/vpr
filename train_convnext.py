...
class config:
    name = "convnext_256_v5"
    root_dir = r"/workspace/unni/gen_img_net/data/pro10k/"  # could be '/home/nick/Data/' or '/mnt/data/nick/'
    csv_file_tr = (
        "train.csv"  # could be 'train.csv' or 'final_data_224/final_data_224.csv'
    )
    csv_file_tt = (
        "test_kaggletest.csv"  # could be 'test.csv' or 'final_data_224/final_data_224.csv'
    )
...
class Classifier_model(nn.Module):
    def __init__(self):
        ...
        self.model = open_clip.create_model_and_transforms('hf-hub:laion/CLIP-convnext_xxlarge-laion2B-s34B-b82K-augreg-soup')[0].visual
        self.fc = ArcFace(
